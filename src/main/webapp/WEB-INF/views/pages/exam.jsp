...
<div class="container">
	...
	<div class="d-flex justify-content-center">
		<form action="<c:url value="/user/updateExams/${exam.id}"/>"
			name="exam" method="post">
			<div class="form-group">
				<label for="exam"> <spring:message code="exam.name" />
				</label> <input type="text" class="form-control" id="exam" name="examName"
			...
			<div class="form-group">
				<label for="totalMarks"> <spring:message
						code="exam.total.marks" />
				</label> <input type="number" class="form-control" id="totalMarks"
					name="totalMarks"
					placeholder="<spring:message code="exam.total.marks"/>"
					value="${exam.totalMarks}" readonly>
			</div>
			<div class="form-group">
				<label for="passingMarks"> <spring:message
						code="exam.passing.marks" />
