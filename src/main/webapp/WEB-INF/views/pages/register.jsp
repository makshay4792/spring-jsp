	...
	<form action="<c:url value="/user/register"/>" method="post"
		...
		<div class="form-group">
			<label for="fullName"> <spring:message
				...
				placeholder="<spring:message code="user.register.fullName"/>"
				required>
		</div>
		<div class="form-group">
			<label for="email"> <spring:message
					code="user.register.email" />
			</label> <input type="email" class="form-control" id="email" name="username"
				aria-describedby="emailHelp"
				placeholder="<spring:message code="user.register.email"/>" required>
			<small id="emailHelp" class="form-text text-muted"><spring:message
					code="user.register.email.message" /></small>
		</div>
		<div class="form-group">
			<label for="password"> <spring:message
				...
				name="password"
				placeholder="<spring:message code="user.register.password"/>"
				required>
		</div>
